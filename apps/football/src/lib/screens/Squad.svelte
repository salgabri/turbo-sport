<script lang="ts">
  ...
  // ---- sticky-header column labels per tab (verbatim from design comp) ----
  ...
  const attributeCols: Col[] = [
    { label: "OVR", width: "50px" },
    { label: "PAC", width: "46px" },
    { label: "SHO", width: "46px" },
    { label: "PAS", width: "46px" },
    { label: "DRI", width: "46px" },
    { label: "TEC", width: "46px" },
    { label: "DEF", width: "46px" },
    { label: "PHY", width: "46px" },
  ];
